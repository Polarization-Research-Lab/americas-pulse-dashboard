...
btn.onclick = function () {
    window.location.href = 'https://apps.polarizationresearchlab.org/api/count/downloads/citizens/all_data.zip';
}
...
btn.onclick = function () {
    ...
    window.open('https://d3ideup5qjydvl.cloudfront.net/' + file);
}
